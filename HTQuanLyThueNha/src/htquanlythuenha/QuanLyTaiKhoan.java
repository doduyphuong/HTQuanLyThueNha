...
public class QuanLyTaiKhoan extends javax.swing.JFrame {
    ...
    public QuanLyTaiKhoan(QuanLyChucNang qlChucNang) {
        initComponents();
        initLayout();
    ...
    private void initLayout() {
        ...
        List<Account> listAccount = accountDAO.loadUSP_ThongKeAccount();
        if (listAccount.size() > 0) {
            for (Account a : listAccount) {
                //"Username", "Role", "Mã NV"
                String[] rows = new String[3];
                rows[0] = a.getUsername();
                rows[1] = String.valueOf(a.getRole());
                rows[2] = String.valueOf(a.getMaNv());
